...
from utils.plots import plot_one_box, padding
...
def detect(src, weights, yaml):
    opt  = {
        "weights": weights, # Path to weights file default weights are for nano model
        "yaml"   : yaml,
